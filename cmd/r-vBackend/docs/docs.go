...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/commands-programs": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Команда, чей операнд мы меняем",
                        "name": "command_id",
                        "in": "query",
                        "required": true
                    },
                    {
                        "description": "Новое значение операнда",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.operandReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.successMessageResp"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/commands/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Добавляемая команда",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/commands/{id}/add-to-program": {
            "post": {
        ...
        "/api/internal/programs/{id}/callback": {
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.riscvCallbackRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/programs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Дата начала фильтрации (формат: DD.MM.YYYY)",
                        "name": "start_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Дата окончания фильтрации (формат: DD.MM.YYYY)",
                        "name": "end_date",
                        "in": "query"
                    }
                ],
        ...
        "/api/programs/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Модифицируемые поля по теме. Можно опустить то, которое мы не будем менять.",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.modifyProgramFieldsReq"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.moderatorDecisionReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.moderatedProgramResp"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/users/log-in": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Введённые пользователем данные",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.userPutReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.moderatedProgramResp": {
            "type": "object",
            "properties": {
                "commands_with_operands": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handler.commandWithOperand"
                    }
                },
                "message": {
                    "type": "string"
                ...
                "program": {
                    "$ref": "#/definitions/handler.programResp"
                },
                "status": {
                    "type": "string"
                }
        ...
        "handler.modifyProgramFieldsReq": {
            "type": "object",
            "properties": {
                "init_t1": {
                    "type": "integer"
